...
$config['licenseName'] =  'gps.strumok.local';
$config['licenseKey']  = '*V?X-*1**-D**V-*D**-*M**-2*F*-4**L';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://10.10.1.10/gps_opt/js/ckfinder/userfiles/',
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    //'baseUrl'      => 'http://10.10.1.10/gps_opt/help/images',
'baseUrl'      => './help/images',
  	'root'         => '/var/www/html/gps_opt/help/images', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
    'filesystemEncoding' => 'UTF-8',
);
