 ...
 */
Ext.define('Opt.ux.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['Opt.ux.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('Opt.ux.DateTimePicker', Ext.merge(initialConfig, parentConfig));
    },
	...
	//timePicker = me.picker.timePicker;
